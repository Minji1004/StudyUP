...
<title>spring</title>
	...
	<link rel="stylesheet" href="<%=cp%>/resource/assets/css/main.css" />
	<!-- Scripts -->
			<script src="<%=cp%>/resource/assets/js/jquery.min.js"></script>
			<script src="<%=cp%>/resource/assets/js/skel.min.js"></script>
			<script src="<%=cp%>/resource/assets/js/util.js"></script>
			<!--[if lte IE 8]><script src="assets/js/ie/respond.min.js"></script><![endif]-->
			<script src="<%=cp%>/resource/assets/js/main.js"></script>
